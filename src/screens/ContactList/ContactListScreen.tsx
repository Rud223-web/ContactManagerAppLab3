...
const ContactListScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleFavoritePress = useCallback(async (contactId: string) => {
  ...
  const handleMessagePress = useCallback((phoneNumber: string) => {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.searchContainer}>
        <CustomInput
          ...
          leftIcon="search"
          rightIcon={searchTerm ? 'clear' : undefined}
      ...
      <View style={styles.sortContainer}>
        <TouchableOpacity onPress={() => setSortBy('name')}>
          <Text style={[styles.sortOption, sortBy === 'name' && styles.sortSelected]}>
            Name
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setSortBy('company')}>
          <Text style={[styles.sortOption, sortBy === 'company' && styles.sortSelected]}>
            Company
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setSortBy('recent')}>
          <Text style={[styles.sortOption, sortBy === 'recent' && styles.sortSelected]}>
            Recent
          </Text>
        </TouchableOpacity>
      </View>
